(() => {
  ...
  const translations = {
    ...
    'Release Notes (App)': ['Release Notes (App)', '发行说明（应用）', '版本說明（App）', 'Notas de versión (App)', 'रिलीज़ नोट्स (ऐप)', 'Notes de version (app)', 'Notas de versão (App)', 'Примечания к выпуску (приложение)', 'リリースノート（App）', '릴리스 노트 (앱)'],
    'Release Notes (Web)': ['Release Notes (Web)', '发行说明（网站）', '版本說明（網站）', 'Notas de versión (web)', 'रिलीज़ नोट्स (वेब)', 'Notes de version (site web)', 'Notas de versão (Web)', 'Примечания к выпуску (сайт)', 'リリースノート（Web）', '릴리스 노트 (웹)'],
    'Web Release Notes': ['Web Release Notes', '网站发行说明', '網站版本說明', 'Notas de versión del sitio web', 'वेबसाइट रिलीज़ नोट्स', 'Notes de version du site web', 'Notas de versão do site', 'Примечания к выпуску сайта', 'Web リリースノート', '웹 릴리스 노트'],
    'FaceAuth — Web Release Notes': ['FaceAuth — Web Release Notes', 'FaceAuth — 网站发行说明', 'FaceAuth — 網站版本說明', 'FaceAuth — Notas de versión del sitio web', 'FaceAuth — वेबसाइट रिलीज़ नोट्स', 'FaceAuth — Notes de version du site web', 'FaceAuth — Notas de versão do site', 'FaceAuth — Примечания к выпуску сайта', 'FaceAuth — Web リリースノート', 'FaceAuth — 웹 릴리스 노트'],
    'Web release updates': ['Web release updates', '网站发行更新', '網站版本更新', 'Actualizaciones de la versión web', 'वेब रिलीज़ अपडेट', 'Mises à jour de la version web', 'Atualizações da versão web', 'Обновления веб-версии', 'Web リリースの更新', '웹 릴리스 업데이트'],
    'Stay up to date with improvements to the FaceAuth website.': ['Stay up to date with improvements to the FaceAuth website.', '及时了解 FaceAuth 网站的改进。', '掌握 FaceAuth 網站的最新改進。', 'Mantente al día con las mejoras del sitio web de FaceAuth.', 'FaceAuth वेबसाइट के सुधारों से अपडेट रहें।', 'Restez informé des améliorations du site web FaceAuth.', 'Acompanhe as melhorias no site do FaceAuth.', 'Следите за улучшениями сайта FaceAuth.', 'FaceAuth Web の改善情報をお届けします。', 'FaceAuth 웹사이트의 개선 사항을 확인하세요.'],
    'Version 1.0 — September 20, 2026': ['Version 1.0 — September 20, 2026', '版本 1.0 — 2026 年 9 月 20 日', '版本 1.0 — 2026 年 9 月 20 日', 'Versión 1.0 — 20 de septiembre de 2026', 'संस्करण 1.0 — 20 सितंबर 2026', 'Version 1.0 — 20 septembre 2026', 'Versão 1.0 — 20 de setembro de 2026', 'Версия 1.0 — 20 сентября 2026 года', 'バージョン 1.0 — 2026 年 9 月 20 日', '버전 1.0 — 2026년 9월 20일'],
    'FaceAuth Website': ['FaceAuth Website', 'FaceAuth 网站', 'FaceAuth 網站', 'Sitio web de FaceAuth', 'FaceAuth वेबसाइट', 'Site web FaceAuth', 'Site do FaceAuth', 'Сайт FaceAuth', 'FaceAuth Web', 'FaceAuth 웹사이트'],
    'Updated FaceAuth Demo Video': ['Updated FaceAuth Demo Video', '更新 FaceAuth 演示视频', '更新 FaceAuth 示範影片', 'Vídeo de demostración de FaceAuth actualizado', 'अपडेट किया गया FaceAuth डेमो वीडियो', 'Vidéo de démonstration FaceAuth mise à jour', 'Vídeo de demonstração do FaceAuth atualizado', 'Обновлённое демонстрационное видео FaceAuth', 'FaceAuth デモ動画を更新', '업데이트된 FaceAuth 데모 영상'],
    'Refined Liquid Glass': ['Refined Liquid Glass', '改进 Liquid Glass', '改進 Liquid Glass', 'Liquid Glass refinado', 'परिष्कृत Liquid Glass', 'Liquid Glass amélioré', 'Liquid Glass refinado', 'Улучшенный Liquid Glass', 'Liquid Glass を改良', '개선된 Liquid Glass'],
    'Ultra-Smooth Scrolling': ['Ultra-Smooth Scrolling', '超流畅滚动', '超流暢捲動', 'Desplazamiento ultrasuave', 'अल्ट्रा-स्मूथ स्क्रॉलिंग', 'Défilement ultra-fluide', 'Rolagem ultrafluida', 'Сверхплавная прокрутка', '超スムーズなスクロール', '초고속 부드러운 스크롤'],
    'FaceAuth AI': ['FaceAuth AI', 'FaceAuth AI', 'FaceAuth AI', 'FaceAuth AI', 'FaceAuth AI', 'FaceAuth AI', 'FaceAuth AI', 'FaceAuth AI', 'FaceAuth AI', 'FaceAuth AI'],
    'Typo-Proof Search': ['Typo-Proof Search', '纠错搜索', '錯字修正搜尋', 'Búsqueda tolerante a errores', 'टाइपो-प्रूफ खोज', 'Recherche tolérante aux fautes', 'Pesquisa tolerante a erros', 'Поиск с исправлением опечаток', '誤入力に強い検索', '오타 보정 검색'],
    'Website Index Search': ['Website Index Search', '网站索引搜索', '網站索引搜尋', 'Búsqueda en el índice del sitio web', 'वेबसाइट इंडेक्स खोज', 'Recherche dans l’index du site', 'Pesquisa no índice do site', 'Поиск по индексу сайта', 'Web サイトインデックス検索', '웹사이트 색인 검색'],
    'Fixed Root Image Loading': ['Fixed Root Image Loading', '修复根目录图片加载', '修復根目錄圖片載入', 'Carga de imágenes raíz corregida', 'रूट इमेज लोडिंग ठीक की गई', 'Chargement des images racine corrigé', 'Carregamento de imagens raiz corrigido', 'Исправлена загрузка корневого изображения', 'ルート画像の読み込みを修正', '루트 이미지 로딩 수정'],
    'Expanded Website Localization': ['Expanded Website Localization', '扩展网站本地化', '擴展網站本地化', 'Localización ampliada del sitio web', 'विस्तारित वेबसाइट स्थानीयकरण', 'Localisation étendue du site web', 'Localização expandida do site', 'Расширенная локализация сайта', 'Web サイトのローカライズを拡張', '웹사이트 현지화 확대'],
    'Navigation & Website Improvements': ['Navigation & Website Improvements', '导航与网站改进', '導覽與網站改進', 'Mejoras de navegación y del sitio web', 'नेविगेशन और वेबसाइट सुधार', 'Améliorations de la navigation et du site web', 'Melhorias de navegação e do site', 'Улучшения навигации и сайта', 'ナビゲーションと Web サイトの改善', '탐색 및 웹사이트 개선'],
    'The approved website demonstration now uses the updated demo video.': ['The approved website demonstration now uses the updated demo video.', '当前获批准的网站演示现使用更新后的演示视频。', '目前核准的網站示範現使用更新後的示範影片。', 'La demostración web aprobada ahora usa el vídeo actualizado.', 'स्वीकृत वेबसाइट डेमो अब अपडेट किए गए डेमो वीडियो का उपयोग करता है।', 'La démonstration web approuvée utilise maintenant la vidéo mise à jour.', 'A demonstração web aprovada agora usa o vídeo atualizado.', 'Утверждённая демонстрация сайта теперь использует обновлённое видео.', '承認済みの Web デモで更新された動画を使用するようになりました。', '승인된 웹사이트 데모가 이제 업데이트된 데모 영상을 사용합니다.'],
    'Navigation and surrounding UI elements now have a cleaner Liquid Glass finish.': ['Navigation and surrounding UI elements now have a cleaner Liquid Glass finish.', '导航和周围 UI 元素现在拥有更简洁的 Liquid Glass 外观。', '導覽與周邊 UI 元素現在採用更簡潔的 Liquid Glass 外觀。', 'La navegación y los elementos de UI circundantes tienen ahora un acabado Liquid Glass más limpio.', 'नेविगेशन और आसपास के UI तत्वों में अब अधिक साफ़ Liquid Glass रूप है।', 'La navigation et les éléments UI environnants ont maintenant une finition Liquid Glass plus nette.', 'A navegação e os elementos de UI ao redor agora têm um acabamento Liquid Glass mais limpo.', 'Навигация и окружающие элементы UI получили более чистый вид Liquid Glass.', 'ナビゲーションと周辺 UI の Liquid Glass 仕上げをよりすっきりさせました。', '탐색 및 주변 UI 요소의 Liquid Glass 마감을 더 깔끔하게 개선했습니다.'],
    'Scrolling is smoother and more fluid throughout the website.': ['Scrolling is smoother and more fluid throughout the website.', '整个网站的滚动更加顺畅流畅。', '整個網站的捲動更加順暢流暢。', 'El desplazamiento es más suave y fluido en todo el sitio.', 'पूरी वेबसाइट में स्क्रॉलिंग अधिक सहज और सुचारु है।', 'Le défilement est plus fluide sur tout le site.', 'A rolagem está mais suave e fluida em todo o site.', 'Прокрутка стала более плавной по всему сайту.', 'Web サイト全体のスクロールがより滑らかになりました。', '웹사이트 전체의 스크롤이 더 부드럽고 자연스러워졌습니다.'],
    'The local FAQ-based FaceAuth AI assistant helps with features, privacy, compatibility, and setup.': ['The local FAQ-based FaceAuth AI assistant helps with features, privacy, compatibility, and setup.', '基于本地 FAQ 的 FaceAuth AI 助手可帮助解答功能、隐私、兼容性和设置问题。', '基於本機 FAQ 的 FaceAuth AI 助理可協助解答功能、隱私、相容性與設定問題。', 'El asistente FaceAuth AI local basado en FAQ ayuda con funciones, privacidad, compatibilidad y configuración.', 'स्थानीय FAQ-आधारित FaceAuth AI सहायक सुविधाओं, गोपनीयता, संगतता और सेटअप में मदद करता है।', 'L’assistant FaceAuth AI local basé sur la FAQ aide pour les fonctions, la confidentialité, la compatibilité et la configuration.', 'O assistente FaceAuth AI local baseado em FAQ ajuda com recursos, privacidade, compatibilidade e configuração.', 'Локальный помощник FaceAuth AI на основе FAQ помогает с функциями, конфиденциальностью, совместимостью и настройкой.', 'ローカル FAQ ベースの FaceAuth AI アシスタントが機能、プライバシー、互換性、設定をサポートします。', '로컬 FAQ 기반 FaceAuth AI 어시스턴트가 기능, 개인정보 보호, 호환성 및 설정을 안내합니다.'],
    'Question matching now recognizes common spelling mistakes and variations.': ['Question matching now recognizes common spelling mistakes and variations.', '问题匹配现在可以识别常见拼写错误和变体。', '問題比對現在可辨識常見拼寫錯誤與變化。', 'La coincidencia de preguntas ahora reconoce errores ortográficos comunes y variaciones.', 'प्रश्न मिलान अब सामान्य वर्तनी की गलतियों और विविधताओं को पहचानता है।', 'La correspondance des questions reconnaît maintenant les fautes courantes et les variantes.', 'A correspondência de perguntas agora reconhece erros comuns e variações.', 'Сопоставление вопросов теперь распознаёт распространённые опечатки и варианты.', '質問マッチングがよくあるスペルミスや変化を認識するようになりました。', '질문 매칭이 일반적인 철자 오류와 변형을 인식합니다.'],
    'FaceAuth AI searches the website content it indexes for relevant answers.': ['FaceAuth AI searches the website content it indexes for relevant answers.', 'FaceAuth AI 会在其索引的网站内容中搜索相关答案。', 'FaceAuth AI 會在其索引的網站內容中搜尋相關答案。', 'FaceAuth AI busca respuestas relevantes en el contenido indexado del sitio.', 'FaceAuth AI प्रासंगिक उत्तरों के लिए इंडेक्स की गई वेबसाइट सामग्री खोजता है।', 'FaceAuth AI recherche des réponses pertinentes dans le contenu indexé du site.', 'O FaceAuth AI pesquisa respostas relevantes no conteúdo indexado do site.', 'FaceAuth AI ищет релевантные ответы в индексированном содержимом сайта.', 'FaceAuth AI はインデックス化した Web コンテンツから関連する回答を検索します。', 'FaceAuth AI가 색인된 웹사이트 콘텐츠에서 관련 답변을 검색합니다.'],
    'Fixed an image loading issue in the website root.': ['Fixed an image loading issue in the website root.', '修复网站根目录中的图片加载问题。', '修復網站根目錄中的圖片載入問題。', 'Se corrigió un problema de carga de imágenes en la raíz del sitio.', 'वेबसाइट रूट में इमेज लोडिंग की समस्या ठीक की गई।', 'Correction d’un problème de chargement d’image à la racine du site.', 'Corrigido um problema de carregamento de imagem na raiz do site.', 'Исправлена проблема загрузки изображения в корне сайта.', 'Web サイトのルートで発生していた画像読み込み問題を修正しました。', '웹사이트 루트의 이미지 로딩 문제를 수정했습니다.'],
    'The selected language now persists across pages, forms, modals, and dynamic content.': ['The selected language now persists across pages, forms, modals, and dynamic content.', '所选语言现在会在页面、表单、模态框和动态内容之间保持。', '選取的語言現在會在頁面、表單、對話框與動態內容間保持。', 'El idioma seleccionado ahora persiste entre páginas, formularios, modales y contenido dinámico.', 'चुनी गई भाषा अब पृष्ठों, फ़ॉर्म, मोडल और डायनेमिक सामग्री पर बनी रहती है।', 'La langue sélectionnée persiste maintenant entre les pages, formulaires, modales et contenus dynamiques.', 'O idioma selecionado agora persiste entre páginas, formulários, modais e conteúdo dinâmico.', 'Выбранный язык теперь сохраняется между страницами, формами, модальными окнами и динамическим содержимым.', '選択した言語がページ、フォーム、モーダル、動的コンテンツ間で保持されるようになりました。', '선택한 언어가 페이지, 양식, 모달 및 동적 콘텐츠에서 유지됩니다.'],
    'Improved navigation, assets, support availability, and deployment reliability.': ['Improved navigation, assets, support availability, and deployment reliability.', '改进导航、资源、支持页面可用性和部署可靠性。', '改進導覽、資產、支援頁面可用性與部署可靠性。', 'Se mejoraron la navegación, los recursos, la disponibilidad del soporte y la fiabilidad del despliegue.', 'नेविगेशन, एसेट, सपोर्ट उपलब्धता और डिप्लॉयमेंट विश्वसनीयता सुधारी गई।', 'Amélioration de la navigation, des ressources, de la disponibilité de l’assistance et de la fiabilité du déploiement.', 'Melhoradas a navegação, os recursos, a disponibilidade do suporte e a confiabilidade da implantação.', 'Улучшены навигация, ресурсы, доступность поддержки и надёжность развёртывания.', 'ナビゲーション、アセット、サポートの利用可能性、デプロイの信頼性を改善しました。', '탐색, 에셋, 지원 가용성 및 배포 안정성을 개선했습니다.'],
    ...
    'License': ['License', '许可', '授權', 'Licencia', 'लाइसेंस', 'Licence', 'Licença', 'Лицензия', 'ライセンス', '라이선스'],
    'Permitted Use': ['Permitted Use', '允许的使用', '允許的使用', 'Uso permitido', 'अनुमत उपयोग', 'Utilisation autorisée', 'Uso permitido', 'Разрешённое использование', '許可された使用', '허용된 사용'],
    'Restrictions': ['Restrictions', '限制', '限制', 'Restricciones', 'प्रतिबंध', 'Restrictions', 'Restrições', 'Ограничения', '制限事項', '제한 사항'],
    'Face Recognition': ['Face Recognition', '面部识别', '臉部辨識', 'Reconocimiento facial', 'चेहरा पहचान', 'Reconnaissance faciale', 'Reconhecimento facial', 'Распознавание лица', '顔認識', '얼굴 인식'],
    'Updates': ['Updates', '更新', '更新', 'Actualizaciones', 'अपडेट', 'Mises à jour', 'Atualizações', 'Обновления', 'アップデート', '업데이트'],
    'Termination': ['Termination', '终止', '終止', 'Terminación', 'समाप्ति', 'Résiliation', 'Rescisão', 'Прекращение', '終了', '종료'],
    'Disclaimer': ['Disclaimer', '免责声明', '免責聲明', 'Descargo de responsabilidad', 'अस्वीकरण', 'Avis de non-responsabilité', 'Aviso legal', 'Отказ от ответственности', '免責事項', '면책 조항'],
    'Limitation of Liability': ['Limitation of Liability', '责任限制', '責任限制', 'Limitación de responsabilidad', 'दायित्व की सीमा', 'Limitation de responsabilité', 'Limitação de responsabilidade', 'Ограничение ответственности', '責任の制限', '책임 제한'],
    'Changes to This Agreement': ['Changes to This Agreement', '本协议的变更', '本合約的變更', 'Cambios en este acuerdo', 'इस समझौते में बदलाव', 'Modifications de cet accord', 'Alterações neste contrato', 'Изменения в этом соглашении', '本契約の変更', '이 계약의 변경'],
    'Information FaceAuth Uses': ['Information FaceAuth Uses', 'FaceAuth 使用的信息', 'FaceAuth 使用的資訊', 'Información que usa FaceAuth', 'FaceAuth द्वारा उपयोग की जाने वाली जानकारी', 'Informations utilisées par FaceAuth', 'Informações usadas pelo FaceAuth', 'Информация, которую использует FaceAuth', 'FaceAuth が使用する情報', 'FaceAuth가 사용하는 정보'],
    'Face Data': ['Face Data', '面部数据', '臉部資料', 'Datos faciales', 'चेहरे का डेटा', 'Données faciales', 'Dados faciais', 'Данные лица', '顔データ', '얼굴 데이터'],
    'Camera Access': ['Camera Access', '摄像头访问', '相機存取', 'Acceso a la cámara', 'कैमरा एक्सेस', 'Accès à la caméra', 'Acesso à câmera', 'Доступ к камере', 'カメラへのアクセス', '카메라 접근'],
    'Data Collection': ['Data Collection', '数据收集', '資料收集', 'Recopilación de datos', 'डेटा संग्रह', 'Collecte de données', 'Coleta de dados', 'Сбор данных', 'データ収集', '데이터 수집'],
    'Third-Party Services': ['Third-Party Services', '第三方服务', '第三方服務', 'Servicios de terceros', 'तृतीय-पक्ष सेवाएँ', 'Services tiers', 'Serviços de terceiros', 'Сторонние сервисы', '第三者サービス', '타사 서비스'],
    'Data Security': ['Data Security', '数据安全', '資料安全', 'Seguridad de los datos', 'डेटा सुरक्षा', 'Sécurité des données', 'Segurança dos dados', 'Безопасность данных', 'データセキュリティ', '데이터 보안'],
    "Children's Privacy": ["Children's Privacy", '儿童隐私', '兒童隱私', 'Privacidad infantil', 'बच्चों की गोपनीयता', 'Confidentialité des enfants', 'Privacidade infantil', 'Конфиденциальность детей', '子どものプライバシー', '아동 개인정보 보호'],
    'Changes to This Policy': ['Changes to This Policy', '本政策的变更', '本政策的變更', 'Cambios en esta política', 'इस नीति में बदलाव', 'Modifications de cette politique', 'Alterações nesta política', 'Изменения в этой политике', 'このポリシーの変更', '이 정책의 변경']
  };
